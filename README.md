...
A premium, high-performance Windows Forms application written in VB.NET on **.NET 10.0-windows**, designed for continuous vertical scrolling credits and text broadcasting via **Blackmagic DeckLink** (SDI/HDMI) output cards.
